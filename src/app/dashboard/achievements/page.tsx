          ...
          <div className="h-full relative">
            ...
            >
              ...
              <div className="flex-1 p-8 overflow-y-auto flex items-center justify-center">
                ...
                >
                  <PiTargetDuotone className="w-16 h-16 text-[#FF9800] mx-auto mb-4" />
                  <h1 className="text-4xl font-bold text-[#1A1A1A] mb-4">Achievement Nexus</h1>
                  <p className="text-lg text-[#363636] max-w-md mx-auto">
                    Celebrate your milestones and unlock rewards. Your learning achievements are displayed here.
                  </p>
                </motion.div>
              </div>
            </motion.div>
