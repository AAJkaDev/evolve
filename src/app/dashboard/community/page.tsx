          ...
          <div className="h-full relative">
            ...
            >
              ...
              <div className="flex-1 p-8 overflow-y-auto flex items-center justify-center">
                ...
                >
                  <PiUsers className="w-16 h-16 text-[#8BC34A] mx-auto mb-4" />
                  <h1 className="text-4xl font-bold text-[#1A1A1A] mb-4">Learning Tribe</h1>
                  <p className="text-lg text-[#363636] max-w-md mx-auto">
                    Connect with fellow learners, collaborate on projects, and grow together in your learning community.
                  </p>
                </motion.div>
              </div>
            </motion.div>
