          ...
          <div className="h-full relative">
            ...
            >
              ...
              <div className="flex-1 p-8 overflow-y-auto flex items-center justify-center">
                ...
                >
                  <PiBank className="w-16 h-16 text-[#E5533C] mx-auto mb-4" />
                  <h1 className="text-4xl font-bold text-[#1A1A1A] mb-4">Campus</h1>
                  <p className="text-lg text-[#363636] max-w-md mx-auto">
                    Connect with your campus resources, events, and academic opportunities.
                  </p>
                </motion.div>
              </div>
            </motion.div>
