          ...
          <div className="h-full relative">
            ...
            >
              ...
              <div className="flex-1 p-8 overflow-y-auto flex items-center justify-center">
                ...
                >
                  <PiNotebook className="w-16 h-16 text-[#4CAF50] mx-auto mb-4" />
                  <h1 className="text-4xl font-bold text-[#1A1A1A] mb-4">Learning Chronicles</h1>
                  <p className="text-lg text-[#363636] max-w-md mx-auto">
                    Track your learning journey, milestones, and personal growth. Your progress story unfolds here.
                  </p>
                </motion.div>
              </div>
            </motion.div>
