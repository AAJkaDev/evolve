          ...
          <div className="h-full relative">
            ...
            >
              ...
              <div className="flex-1 p-8 overflow-y-auto flex items-center justify-center">
                ...
                >
                  <PiCode className="w-16 h-16 text-[#9C27B0] mx-auto mb-4" />
                  <h1 className="text-4xl font-bold text-[#1A1A1A] mb-4">Code Forge</h1>
                  <p className="text-lg text-[#363636] max-w-md mx-auto">
                    Your programming workspace for coding challenges, projects, and collaborative development.
                  </p>
                </motion.div>
              </div>
            </motion.div>
