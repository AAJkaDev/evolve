          ...
          <div className="h-full relative">
            ...
            >
              ...
              <div className="flex-1 p-8 overflow-y-auto flex items-center justify-center">
                ...
                >
                  <PiBrain className="w-16 h-16 text-[#4285F4] mx-auto mb-4" />
                  <h1 className="text-4xl font-bold text-[#1A1A1A] mb-4">Memory</h1>
                  <p className="text-lg text-[#363636] max-w-md mx-auto">
                    Your personalized memory space for storing and organizing important learning materials and insights.
                  </p>
                </motion.div>
              </div>
            </motion.div>
