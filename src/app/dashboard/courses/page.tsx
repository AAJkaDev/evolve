          ...
          <div className="h-full relative">
            ...
            >
              ...
              <div className="flex-1 p-8 overflow-y-auto flex items-center justify-center">
                ...
                >
                  <PiBookOpenText className="w-16 h-16 text-[#34C9A3] mx-auto mb-4" />
                  <h1 className="text-4xl font-bold text-[#1A1A1A] mb-4">Courses</h1>
                  <p className="text-lg text-[#363636] max-w-md mx-auto">
                    Browse and enroll in structured learning courses tailored to your educational goals.
                  </p>
                </motion.div>
              </div>
            </motion.div>
